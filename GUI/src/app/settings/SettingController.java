...
public class SettingController implements Initializable {
    ...
    public static final String SWITCH_PLUG_FXML = "/app/smallComponent/switchPlug.fxml";
    public static final String REFLECTOR_BUTTON_FXML = "/app/smallComponent/reflectorButton.fxml";
    ...
    private void setReflectors() {
        ...
        for (int i = 0; i < this.machineInformation.getAvailableReflectors(); i++) {
            ...
            reflector.setOnAction((e) ->
            {
                ...
                this.selectedReflector = Utils.convertRomanToInt((selectedReflector.getText()));
                this.unselectAllReflectors();
                selectedReflector.setId(SELECTED_REFLECTOR);

            });
            reflector.setText(Utils.convertIntToRoman(i + 1));
