...
public class Machine implements Serializable {
    ...
    public void loadReflector(CTEEnigma enigma_machine) {
        ...
        for (CTEReflector xmlReflector : xmlReflectorArr.getCTEReflector()) {
            ...
            int position = Utils.convertRomanToInt(xmlReflector.getId())-1;
    ...
    private static int convertRomanToInt(String romanNumber) {
        switch (romanNumber) {
            case "I":
                return 0;
            case ("II"):
            ...
            case ("V"):
                return 4;
            default:
                throw new IllegalArgumentException("Invalid machineparts.Reflector,id must be I,II,III,IV,V");
        }
    }
